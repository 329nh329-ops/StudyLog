...
管理者アカウントでのログインから、ダッシュボード・学習記録登録・学習記録一覧・カテゴリ管理・ユーザー管理・ログアウトまでの一連の操作を録画したものです。

https://github.com/user-attachments/assets/af2f060c-7659-41ea-abfc-2547e655e046
