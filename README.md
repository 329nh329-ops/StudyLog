...
管理者アカウントでのログインから、ダッシュボード確認・学習記録登録・登録内容がダッシュボードのグラフに反映される様子・学習記録一覧・カテゴリ管理・ユーザー管理・ログアウトまでの一連の操作を録画したものです。

https://github.com/user-attachments/assets/8fb9fefd-b8b1-4c9d-874d-ccf6c7bf84dc
